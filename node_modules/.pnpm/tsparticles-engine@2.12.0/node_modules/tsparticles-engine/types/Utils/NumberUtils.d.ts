import type { EasingType, EasingTypeAlt } from ".pnpm/tsparticles-engine@2.12.0/node_modules/tsparticles-engine/types/Enums/Types/EasingType";
import type { IPositionFromSizeParams, IRangedPositionFromSizeParams } from ".pnpm/tsparticles-engine@2.12.0/node_modules/tsparticles-engine/types/Core/Interfaces/IPositionFromSizeParams";
...
import type { IValueWithRandom } from ".pnpm/tsparticles-engine@2.12.0/node_modules/tsparticles-engine/types/Options/Interfaces/IValueWithRandom";
import { MoveDirection } from ".pnpm/tsparticles-engine@2.12.0/node_modules/tsparticles-engine/types/Enums/Directions/MoveDirection";
import type { MoveDirectionAlt } from ".pnpm/tsparticles-engine@2.12.0/node_modules/tsparticles-engine/types/Enums/Directions/MoveDirection";
